...
##' Load the raw data from file or database and 
##' Process the dataset ready for modelling (HES + SWD).
##'
##' This function takes the HES dataset and joins the
##' primary care attributes data. This substantially
##' reduces the amount of data, because index events are
##' only kept for patients that also have a primary
##' care attributes row. The most recent data before the
