...
Numerical predictors were centered and scaled. Neither up-sampling nor down-sampling the data by the bleeding or ischaemia outcomes was found to improve model performance, and in some cases substantially reduced it. As a result, this preprocessing operation was not performed, even though its use is indicated by the class imbalance in the bleeding/ischaemia outcomes.
